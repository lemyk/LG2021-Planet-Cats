...
public class indexPage extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.bSympTrack).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(indexPage.this)
                        .navigate(R.id.action_indexPage_to_sympTrack);
            }
        });
    }
}